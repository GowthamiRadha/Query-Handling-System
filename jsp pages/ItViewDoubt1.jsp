...
<br>
<form action="ItViewDoubt1.jsp" method="post">
...
<br/><br/>
<form action="ItViewDoubt1.jsp" method="get">
...
<%	  
		try
					{
					  Statement st1 =  con.createStatement();
					  ResultSet rs1=st1.executeQuery("select * from itReplyDoubt where doubt='"+doubt+"'");
					  while(rs1.next())
					  {%>
					<div class="border1">  					
					<p class="regNo"><%= rs.getString(1) %></p>
