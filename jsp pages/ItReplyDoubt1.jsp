...
<form action="ItReplyDoubt1.jsp" method="post">
<select name="subject">
...
<% 
	...
	if(subject!=null && subject!="")
	{
		try
		{
				...
				ResultSet rs=st.executeQuery("select * from ItAskDoubt where subject='"+subject+"'");
				
				
				while(rs.next())
				{%>
					<div  class="border" >
						<form action="ItReplyDoubt1.jsp"  method="post" autocomplete="off">
...
<%
	...
	{
		ItReplyDoubt c=new ItReplyDoubt();
		c.setItReplyDoubt( regNo,subject, doubt,answer);
		out.println("<script type=\"text/javascript\">");
		out.println("confirm('Posting is successfull  Click ok');");
		out.println("location='it.jsp';");
		out.println("</script>");
	}
%>
