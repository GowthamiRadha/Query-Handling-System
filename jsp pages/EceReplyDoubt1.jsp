...
<form action="EceReplyDoubt1.jsp" method="post">
<select name="subject">
...
<% 
	...
	if(subject!=null && subject!="")
	{
		try
		{
				...
				{%>
					<div  class="border" >
						<form action="EceReplyDoubt1.jsp"  method="post" autocomplete="off">
...
<%
	...
	{
		EceReplyDoubt c=new EceReplyDoubt();
		c.setEceReplyDoubt( regNo,subject,doubt,answer);
		out.println("<script type=\"text/javascript\">");
		out.println("confirm('Posting is successfull  Click ok');");
		out.println("location='ece.jsp';");
		out.println("</script>");
	}
%>
